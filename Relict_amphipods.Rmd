...
#originally Period 2 included some last years from the 20th century for a better data balance (the division between the two periods is rather arbitrary), but because this may look like data manipulation, we now use century strictly. Results are anyway the same, although the data balance between the two periods is now not as good. 
